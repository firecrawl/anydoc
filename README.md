...
Fast Rust library that converts documents (Word, PowerPoint, Excel, OpenDocument, RTF, EPUB, CSV, and PDF) into clean GitHub-Flavored Markdown. Includes bindings for [Node.js](node/README.md), [Python](python/README.md), the [browser](wasm/README.md) (WebAssembly), and [.NET](dotnet/README.md) (NuGet `Firecrawl.Anydoc`).
